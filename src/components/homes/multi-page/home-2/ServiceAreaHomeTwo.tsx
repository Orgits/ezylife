...
const ServiceAreaHomeTwo = () => {
  return (
    <>
      <section id="services-one-page" className="tp-service-area-2 pt-120 pb-145" style={{ backgroundColor: '#F6F6F9' }}>
            ...
            <div className="row">
              {services.map((item, index) => (
                <div key={index} className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="tp-service-item-2 p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay={item.delay}>
                      ...
                      <div className="tp-service-btn-2">
                          <Link href="/service-details"><i className="fa-regular fa-arrow-right"></i></Link>
                      </div>
                    </div>
                </div>                
              ))} 
