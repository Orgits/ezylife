...
const AboutAreaHomeOne = () => {
  return (
    <>
      <section id="about-one-page" className="tp-about-area p-relative pt-130 pb-210">
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6">
                     <div className="tp-about-thumb-wrapper p-relative wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                        <div className="main">
                           <Image src={about_img} alt="image-title-here" />
                        </div>
                        <Image className="shape-1" src={about_shape_1} alt="image-title-here" />
                        <Image className="shape-2" src={about_shape_2} alt="image-title-here" />
                        <Image className="shape-3" src={about_shape_3} alt="image-title-here" />
                        <Image className="shape-4" src={about_shape_4} alt="image-title-here" />
                     </div>
                  </div>
                  <div className="col-lg-6">
                     <div className="tp-about-wrapper">
                        ...
                        <p>{sm_des}</p>
                        <div className="tp-about-mission" style={{ marginTop: '25px', marginBottom: '30px' }}>
                           <h4 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '15px' }}>Our Missions</h4>
                           <div className="tp-about-wrapper-list">
                              <ul>
                                 {features.map((item, index) => (
                                 <li key={index}  style={{ fontSize: '16px' }}><span><i className="fa-regular fa-circle"></i></span> {item}</li>
                                 ))}
                              </ul>
                           </div>
                        </div>
