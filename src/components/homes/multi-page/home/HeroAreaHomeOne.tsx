...
const hero_data: DataType[] = [
  ...
  },
  {
    ...
    sm_des: 'And In Order To Make A Business, Brand Advertising And Marketing Plays An Important Role. Similarly, In Making Cultivation Business A Brand, Good Slogans Are Necessary.',
    phone: '+91 9876543210',
  },
  {
    id: 3,
                          ...
                          <div className="col-lg-7">
                            <div className="tp-hero-content p-relative">
                                ...
                                <div className="tp-hero-promises mb-30">
                                  <h4 className="tp-promises-title animate-title mb-15">Our Promises</h4>
                                  <div className="tp-promises-list d-flex flex-wrap">
                                    <div className="tp-promise-item animate-item-1 d-flex align-items-center mr-30 mb-10">
                                      ...
                                      <p className="mb-0">Trusted by clients across India</p>
                                    </div>
                                    <div className="tp-promise-item animate-item-2 d-flex align-items-center mr-30 mb-10">
                                      <div className="tp-promise-circle mr-10"></div>
                                      <p className="mb-0">Backed by IIFL's robust technology & research</p>
                                    </div>
                                    <div className="tp-promise-item animate-item-3 d-flex align-items-center mb-10">
                                      <div className="tp-promise-circle mr-10"></div>
                                      <p className="mb-0">Tailored financial solutions for every stage of life</p>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="tp-hero-button-wrapper d-flex flex-wrap align-items-center">
                                  ...
                                  <div className="tp-hero-call d-flex align-items-center">
                                    ...
                                    <div className="tp-hero-call-inner">
                                      <p>Need help?</p>
                                      <span><a href="tel:5550111">{item.phone}</a></span>
                                    </div>
                                  </div>
                                </div>
                            </div>
                          ...
                          <div className="col-lg-5">
                            <div className="tp-hero-thumb p-relative">
                                <div className="tp-hero-thumb-shape">
                                  <Image className="shape-1" src={hero_shape_1} alt="image-title-here" />
                                  <Image className="shape-2" src={hero_shape_2} alt="image-title-here" />
                                  <Image className="shape-3" src={hero_shape_3} alt="image-title-here" />
                                </div>
