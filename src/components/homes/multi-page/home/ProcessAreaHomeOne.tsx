...
const process_counter: DataType = {
  ...
  title: <>Strategy is the key to <br /> success</>,
  features: [
    {
      img: process_icon_1,
      title: 'Best emplementation',
      sm_des: 'Ished fact that a reader will be distrol acted bioiiy desig the.ished fact that a reader will be distrol acted bioiiy bioiiy desig the.ished fact that a reader.'
    },
    {
      img: process_icon_2,
...
const ProcessAreaHomeOne = () => {
  return (
    <>
      <section className="tp-process-arae pt-120 pb-120" style={{ backgroundColor: '#F6F6F9' }}>
        <div className="container">
            <div className="row">
              <div className="col-lg-6">
                  <div className="tp-process-wrapper">
                    ...
                    {features.map((item, index) => (
                      <div className="tp-process-item d-flex align-items-center" key={index}>
              ...
              <div className="col-lg-6">
                  <div className="tp-process-thumb-wrapper p-relative wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div className="tp-process-thumb p-relative">
                        <div className="main">
                          <Image src={process_img_1} alt="image-title-here" />
                        </div>
                        <Image className="shape-1" src={process_img_2} alt="image-title-here" />
                    </div>
