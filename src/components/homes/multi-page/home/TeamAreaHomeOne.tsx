...
const TeamAreaHomeOne = ({ style }: any) => {
  return (
    <>
      <section className={`tp-team-area pb-120 ${style ? 'pt-120' : ''} tp-team-item-margin`}>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-team-title-wrapper text-center mb-40">
                <span className="tp-section-title-pre">our team </span>
                <h3 className="tp-section-title">Leading the way in business <br /> transformation</h3>
              </div>
            </div>
          </div>
          <div className="row">
              ...
              <>
                {item.home === 1 &&
                  <div key={index} className="col-lg-3 col-md-6">
                    <div className="tp-team-item p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay={item.delay}>
