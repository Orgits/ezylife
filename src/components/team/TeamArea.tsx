                ...
                <div className="tp-team-item p-relative mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay={item.delay}>
                  <div className="tp-team-item-thumb">
                    <Link href={`/team-details/${item.id}`}>
                      <Image src={item.img} style={{ width: '100%', height: 'auto' }} alt={`${item.title} - ${item.designation}`} width={300} height={400} />
                    </Link>
                  </div>
                  ...
                  <div className="tp-team-info text-center">
                    <h4 className="tp-team-info-title"><Link href={`/team-details/${item.id}`}>{item.title}</Link></h4>
