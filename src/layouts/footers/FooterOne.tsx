...
const footer_content: DataType = {
  sm_info: "Payment processing is a critical component of any business that sells goods or se Payment processing is a critical component of any.",
...
const { sm_info, link_title, link_list, post_title, post_list, footer_links } = footer_content;

const FooterOne = () => {
  return (
    <>
      <footer className="tp-footer-area pt-80  z-index-1" style={{ backgroundColor: '#16243E' }}>
                    ...
                    {post_list.map((item, index) => (
                      <div key={index} className="tp-footer-widget-item">
                        <h4 className="tp-footer-widget-item-title">
                          <Link href="/blog-details">{item.title}</Link></h4>
                    ...
                    <div className="tp-footer-widget-contact">
                      <div className="tp-footer-widget-contact-inner">
                        <a href="https://www.google.com/maps" target="_blank">
                          <i className="fa-sharp fa-solid fa-location-dot"></i> 6391 Elgin St. Celina, 10299</a>
                      </div>
                      <div className="tp-footer-widget-contact-inner">
                        <a href="tel:123456765"><i className="fa-solid fa-phone"></i> (629) 555-0129</a>
                      </div>
                      <div className="tp-footer-widget-contact-inner">
                        <a href="mailto:info@example.com"><i className="fa-solid fa-envelope"></i> info@example.com</a>
                      </div>
                    </div>
                  </div>
                </div>
