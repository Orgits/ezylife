...
const { sm_info, link_title, link_list, post_title, post_list, news_text, news_title, footer_links } = footer_content;


const FooterTwo = () => {
  return (
    <>
      <footer className="tp-footer-area-2 pt-140 p-relative z-index-1" style={{ backgroundColor: '#16243E' }}>
        <div className="tp-footer-bg-shape-2">
          <Image className="shape-1" src={footer_shape_1} alt="image-title-here" />
          <Image className="shape-2" src={footer_shape_2} alt="image-title-here" />
        </div>
                  ...
                  <div className="tp-footer-widget-content">
                    ...
                    <div className="tp-footer-content-email">
                      <form onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button> <span><i className="fa-solid fa-paper-plane"></i></span></button>
                      </form>
                    </div>
                  </div>
                </div>
