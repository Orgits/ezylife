                        ...
                        <div key={index} className="col homemenu">
                          <div className="homemenu-thumb mb-15">
                            ...
                            <div className="homemenu-btn">
                              <Link className="menu-btn show-1" href={sub_menu.link}><span>Multi Page</span></Link> <br />
                              <Link className="menu-btn show-2" href={sub_menu.one_page_link}><span>One Page</span></Link>
                            </div>
                          </div>
