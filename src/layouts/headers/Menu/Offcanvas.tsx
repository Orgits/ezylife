...
const Offcanvas = ({ menuOpen, setMenuOpen , onePageHomeOne}: any) => {
  return (
    <>
      <div className={`offcanvas__area ${menuOpen ? "offcanvas-opened" : ""}`}>
        <div className="offcanvas__wrapper">
          <div className="offcanvas__close">
            <button className="offcanvas__close-btn offcanvas-close-btn" onClick={() => setMenuOpen(false)}>
      ...
      <div className={`body-overlay ${menuOpen ? "opened" : ""}`} onClick={() => setMenuOpen(false)}></div>
    </>
  );
};
