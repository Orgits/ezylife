...
const SearchBar = ({ searchOpen, setSearchOpen }: any) => {
  ...
  return (
    <>
                    ...
                    <div className="d-flex justify-content-center px-5">
                      <div className="search w-100 p-relative">
                        <form onSubmit={searchHanle}>
                          <input type="text" className="search-input" placeholder="Search..." defaultValue={searchText} onChange={e => setSearchText(e.target.value)} />
      ...
      <div className={`search-overlay ${searchOpen ? 'opened' : ''}`} onClick={() => setSearchOpen(false)}></div>
